...
link('/hsl/homes/jgoppert/Projects/oooark/build/src/scicos/liboooarkScicos.so',[stdBlocks;jsbsimBlocks;mavlinkBlocks;simgearBlocks;osgBlocks;lapackBlocks]','c');
...
genlib('lib_oooarkLinear',pwd()+'/oooarkLinear');
//create_palette('oooarkLinear');
//add_palette('oooark Linear',pwd()+'/oooarkLinear/oooarkLinear.cosf');

clear stdBlocks simgearBlocks osgBlocks jsbsimBlocks lapackBlocks mavlinkBlocksode(-1)
