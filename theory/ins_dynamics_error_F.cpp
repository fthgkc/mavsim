...
F[1,1] = (b*c-2*a*d)*wz+(-b*d-2*a*c)*wy-a*b*wx;
F[1,2] = -((Omega*sinL+(-dd-3*cc-bb+3*aa)*wz+(6*c*d+4*a*b)*wy-6*a*c*wx)*R+Ve*tanL)/R/2.0;
F[1,3] = (((2*c*d-4*a*b)*wz+(-3*dd-3*cc-bb+3*aa)*wy+6*a*d*wx)*R+Vn)/R/2.0;
F[1,4] = d/R/2.0;
...
F[2,2] = (-2*a*d-b*c)*wz+a*c*wy+(c*d-2*a*b)*wx;
...
F[3,1] = ((6*a*b*wz+(dd+3*cc+3*bb-3*aa)*wy+(-4*a*d-2*b*c)*wx)*R-Vn)/R/2.0;
F[3,2] = -((Omega*cosL-6*a*c*wz+(4*a*d-6*b*c)*wy+(dd+3*cc+bb-3*aa)*wx)*R+Ve)/R/2.0;
F[3,3] = -a*d*wz+(b*d-2*a*c)*wy+(-c*d-2*a*b)*wx;
F[3,4] = -b/R/2.0;
